...
INPUT_FILE = os.path.join(assets_dir, "resource_taxonomy_table") # Adjust path if needed
HIERARCHY_FILE = os.path.join(assets_dir, "resource_hierarchy_table.json")
VALID_RES_FILE = os.path.join(assets_dir, "valid_resource_table.json")
